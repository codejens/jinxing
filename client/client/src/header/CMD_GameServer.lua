...
game_cmd.CMD_GR_RequestFailure =
{
	...
	{k = "szDescribeString", t = "string", s = 256}
...
game_cmd.tagTaskParameter = 
{
	...
	-- 奖励信息
	-- 奖励金币
	{t = "double", k = "lStandardAwardGold"},
	-- 奖励奖牌
	{t = "double", k = "lStandardAwardMedal"},
	-- 奖励金币
	{t = "double", k = "lMemberAwardGold"},
	-- 奖励奖牌
	{t = "double", k = "lMemberAwardMedal"},
...
game_cmd.CMD_GR_S_TaskResult =
{
	...
	-- 财富信息
	-- 当前金币
	{t = "double", k = "lCurrScore"},
	-- 当前元宝
	{t = "double", k = "lCurrIngot"},
