...
function TaskItem:onInit(pData,len)
	...
	self.lStandardAwardGold		= pData:readdouble()		--奖励金币
    self.lStandardAwardMedal	= pData:readdouble()		--奖励奖牌
    self.lMemberAwardGold		= pData:readdouble()		--奖励金币
    self.lMemberAwardMedal		= pData:readdouble()		--奖励奖牌
