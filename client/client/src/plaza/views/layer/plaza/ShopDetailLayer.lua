...
function ShopDetailLayer:ctor(scene, gameFrame)
	...
	if self._item.bean ~= 0 then
		cc.Label:createWithTTF(string.formatNumberThousands(self._item.bean,true,",").."游戏豆", "base/fonts/round_body.ttf", 24)
	...
	if self._item.ingot ~= 0 then
		cc.Label:createWithTTF(string.formatNumberThousands(self._item.ingot,true,",").."元宝", "base/fonts/round_body.ttf", 24)
        	:setAnchorPoint(cc.p(0.0,0.5))
        	:move(144,y)
	...
	if self._item.gold ~= 0 then
		cc.Label:createWithTTF(string.formatNumberThousands(self._item.gold,true,",").."游戏币", "base/fonts/round_body.ttf", 24)
        	:setAnchorPoint(cc.p(0.0,0.5))
        	:move(144,y)
	...
	--[[if self._item.loveliness ~= 0 then
		cc.Label:createWithTTF(string.formatNumberThousands(self._item.loveliness,true,",").."魅力值", "base/fonts/round_body.ttf", 24)
        	:setAnchorPoint(cc.p(0.0,0.5))
        	:move(144,y)
    ...
    -- 折扣
    self._txtDiscount = cc.Label:createWithTTF(self.m_discount .. "%折扣", "base/fonts/round_body.ttf", 25)
            :setAnchorPoint(cc.p(1.0,0.5))
	...
	--功能描述
	cc.Label:createWithTTF("功能："..self._item.description, "base/fonts/round_body.ttf", 22)
        	:setAnchorPoint(cc.p(0.0,0.5))
        	:move(417,70)
