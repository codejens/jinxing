...
private_define.LEN_PERSONAL_TABLE_PARAMETER = 44                            -- sizeof(tagPersonalTableParameter)
...
tabLayTag.LAYER_GAMELISTROOME      = 1002                                   -- MXM私人房游戏列表界面
tabLayTag.LAYER_CREATEPRIROOME     = 1003                                   -- 创建私人房界面
tabLayTag.LAYER_MYROOMRECORD       = 1004                                   -- 我的房间(记录)
tabLayTag.LAYER_HELP               = 1005                                   -- 帮助界面
tabLayTag.LAYER_ROOMID             = 1006                                   -- 房间ID输入
tabLayTag.LAYER_CREATERESULT       = 1007                                   -- 创建结果
tabLayTag.LAYER_EXCHANGESCORE      = 1008                                   -- 房卡兑换游戏币
tabLayTag.LAYER_BUYCARD            = 1009                                   -- 游戏豆购买房卡
tabLayTag.LAYER_FRIENDLIST         = 1010                                   -- 好友分享列表
