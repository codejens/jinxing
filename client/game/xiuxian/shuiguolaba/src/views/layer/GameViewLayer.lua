...
--	--最小押注 ----等于重置  --要增加压线变成一
	...
	self.m_textScore:setString(self._scene:GetMeUserItem().lScore)     --self._scene:GetMeUserItem().lScore
	--压线
...
--	--得到分数
 ...
 --   self.record :setVisible(true)
    self.recordTip = cc.Label:createWithTTF("暂无记录","base/fonts/round_body.ttf",48)
  ...
  --           end
				...
				self:runAction(
                    ...
                    --    	 self:game1Result()
                           ...
                           if pActionOneYaXian.nZhongJiangXian == 1 then
                           sprLine:setPosition(577,355)
                           elseif pActionOneYaXian.nZhongJiangXian == 2 then
                           sprLine:setPosition(577,477)
                           elseif pActionOneYaXian.nZhongJiangXian == 3 then
                           sprLine:setPosition(577,235)
                           elseif pActionOneYaXian.nZhongJiangXian == 4 then
                           sprLine:setPosition(577,373)
                           elseif pActionOneYaXian.nZhongJiangXian == 5 then
                           sprLine:setPosition(577,343)
                           else
			               sprLine:setPosition(577,360)
                           end
